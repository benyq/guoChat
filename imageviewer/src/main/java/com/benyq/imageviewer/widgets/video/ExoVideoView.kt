...
open class ExoVideoView @JvmOverloads constructor(
    ...
    fun resume() {
        ...
        Log.i("viewer", "video resume $url $simpleExoPlayer")
    ...
    fun pause() {
        Log.i("viewer", "video pause $playUrl $simpleExoPlayer")
        simpleExoPlayer?.playWhenReady = false
    }

    fun reset() {
        Log.i("viewer", "video reset $playUrl $simpleExoPlayer")
    ...
    fun release() {
        ...
        Log.i("viewer", "video release $playUrl $player")
    ...
    override fun onDetachedFromWindow() {
        ...
        Log.i("viewer", "video onDetachedFromWindow $playUrl $simpleExoPlayer")
        release()
    }
    ...
    override fun onAttachedToWindow() {
        ...
        if (simpleExoPlayer == null) {
            Log.i("viewer", "video onAttachedToWindow $playUrl")
            playUrl?.let(::prepare)
        }
    }
}