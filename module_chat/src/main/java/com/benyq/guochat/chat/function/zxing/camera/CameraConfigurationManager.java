...
package com.benyq.guochat.chat.function.zxing.camera;
...
import com.benyq.guochat.chat.function.zxing.android.PreferencesActivity;
...
final class CameraConfigurationManager {
	...
	void initFromCameraParameters(Camera camera) {
		...
		Point theScreenResolution = ScreenUtil.getScreenSize(context);
