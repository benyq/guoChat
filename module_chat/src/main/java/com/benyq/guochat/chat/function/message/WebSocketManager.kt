...
object WebSocketManager {
    ...
    private fun dealChatMessage(bean: ChatMessageBean) {
        val conversion = ChatObjectBox.getConversationId(bean.toId, bean.fromId)
        val contract = ChatObjectBox.getContractByConversation(conversion.id)
        //先保存本地数据库
        ...
        ChatObjectBox.updateChatRecord(conversion.id, bean.sendTime)
        ...
        NotificationHelper.showMessageNotification(context, contract!!.nick, lastConversion)
    }
}