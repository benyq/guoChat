...
package com.benyq.guochat.model.bean.openeye
 ...
 * @since  2020/5/9
 */
data class Daily(val itemList: List<Item>, val count: Int, val total: Int, val nextPageUrl: String?, val adExist: Boolean) {
