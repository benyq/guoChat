...
class DrawableBuilder(private val mContext: Context) {
   ...
   init {
       cornerRadius = mContext.dip2px(2f)
   }
    ...
    fun lineWidth(lineWidth: Int): DrawableBuilder {
        this.lineWidth = mContext.dip2px(lineWidth).toInt()
        return this
    }
    ...
    fun corner(cornerRadius: Float): DrawableBuilder {
        this.cornerRadius = mContext.dip2px(cornerRadius)
        return this
    }
    ...
    fun dashWidth(dashWidth: Float): DrawableBuilder {
        this.dashWidth = mContext.dip2px(dashWidth)
        return this
    }

    fun dashGap(dashGap: Float): DrawableBuilder {
        this.dashGap = mContext.dip2px(dashGap)
        return this
    }
}